...
import { l as loadPhotos } from "./photo-store-csdjgAAq.js";
...
function PrintAnimation({ photos }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto flex w-full max-w-5xl flex-col items-center px-6 py-16 md:py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] uppercase tracking-[0.35em] text-brown", children: "Fresh off the printer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 font-display text-5xl text-charcoal md:text-7xl", children: "Your strip." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-hand text-2xl text-brown-deep", children: "still warm." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto h-6 w-full rounded-t-md bg-charcoal", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 top-1/2 h-1.5 w-3/4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-black/60" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex justify-center overflow-visible pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: stripRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
...
function ResultPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen bg-cream text-charcoal", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PrintAnimation, { photos })
  ] });
}
export {
